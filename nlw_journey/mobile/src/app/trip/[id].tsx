...
import { CalendarRange, Info, MapPin, Settings2, Calendar as CalendarIcon, User, Mail } from "lucide-react-native";
...
export default function Trip(){
    ...
    return <View className="flex-1 px-5 pt-16">
        ...
        <View
        className="w-full absolute -bottom-1 self-center justify-end pb-5 bg-zinc-950">
            <View
            className="w-full flex-row bg-zinc-900 p-4 rounded-lg border border-l-zinc-800 gap-2">
                <Button
                className="flex-1"
