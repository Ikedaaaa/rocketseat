...
export function HabitDay({date, amountOfHabits = 0, amountCompleted = 0, ...rest}: Props){
    ...
    return (
        <TouchableOpacity className={clsx("rounded-lg border-2 m-1", {
            ...
            "bg-yellow-600 border-yellow-700": amountAccomplishedPercentage === 100, //Adicionei essa condição mais pra teste, mas também pra deixar o dia em destaque se completar todos os hábitos
            "border-white border-4": isCurrentDay
        })} style={{width: DAY_SIZE, height: DAY_SIZE}} activeOpacity={0.7} {...rest} />
    );
}